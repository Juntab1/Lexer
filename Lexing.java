...
public class Lexing{
    public static void main(String args[]){
        ...
        ArrayList<String> singleCharKey = new ArrayList<>(Arrays.asList("(", ")", "{", "}", ";", ".", "\"", ";", "*", "\\", ",", ":", "[", "]"));
        ArrayList<String> multiCharKey = new ArrayList<>(Arrays.asList("String", "int", "public", "static", "void", "main", "for", "class", "\n", "//", "/*", "*/"));
        String ans = "";
